...
function read_MED_GUI()
    ...
    persistenceModeLabel = text('Position', [(axRight - TEXT_BOX_WIDTH - 10) (axTop - 314)], ...
    ...
    persistenceModeDropdown = uicontrol(fig, ...
        ...
        'Position', [(faxRight - TEXT_BOX_WIDTH - 7) (faxTop - 321) (TEXT_BOX_WIDTH + 16) TEXT_BOX_HEIGHT], ...
        'BackgroundColor', 'white', ...
        'FontSize', SYS_FONT_SIZE, ...
        'FontName', 'FixedWidth', ...
        'HorizontalAlignment', 'left');
    ...
    variableNameLabel = text('Position', [(axRight - TEXT_BOX_WIDTH - 10) (axTop - 394)], ...
    ...
    variableNameTextbox = uicontrol(fig, ...
        ...
        'Position', [(faxRight - TEXT_BOX_WIDTH) (faxTop - 394) TEXT_BOX_WIDTH TEXT_BOX_HEIGHT], ...
        'BackgroundColor', 'white', ...
        'FontSize', SYS_FONT_SIZE, ...
        'FontName', 'FixedWidth', ...
        'HorizontalAlignment', 'left');
    ...
    function [success] = get_data()
        ...
        sess = read_MED(file_list, start_time, end_time, start_index, end_index, passwordTextbox.UserData.password, referenceChannelTextbox.String, samps_as_singles, persist_num);
