...
#define METADATA_FIELDS_SESSION_NUMBER_OF_SAMPLES_IDX_mat		9
#define METADATA_FIELDS_SESSION_NAME_IDX_mat                            10
#define METADATA_FIELDS_CHANNEL_NAME_IDX_mat                            11
#define METADATA_FIELDS_INDEX_CHANNEL_NAME_mat				12
...
#define NUM_REC_TYPES	5
// in layer order for view_MED (bottom to top
#define REC_HFOc_IDX	0
#define REC_NlxP_IDX	1
#define REC_Note_IDX	2
#define REC_Seiz_IDX	3
#define REC_Sgmt_IDX	4
