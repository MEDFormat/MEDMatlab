...
function matrix_MED_GUI()
    ...
    persistenceModeLabel = text('Position', [(axRight - TEXT_BOX_WIDTH - 10) (axTop - 422)], ...
    ...
    persistenceModeDropdown = uicontrol(fig, ...
        'Style', 'popupmenu', ...
        'String', {'None (default)', 'Open', 'Close', 'Read Current', 'Read New', 'Read & Close'}, ...
        'Position', [(faxRight - TEXT_BOX_WIDTH - 7) (faxTop - 429) (TEXT_BOX_WIDTH + 16) TEXT_BOX_HEIGHT], ...
        'BackgroundColor', 'white', ...
        'FontSize', SYS_FONT_SIZE, ...
        'FontName', 'FixedWidth', ...
        'HorizontalAlignment', 'left');
    ...
    variableNameLabel = text('Position', [(axRight - TEXT_BOX_WIDTH - 10) (axTop - 462)], ...
    ...
    variableNameTextbox = uicontrol(fig, ...
        ...
        'Position', [(faxRight - TEXT_BOX_WIDTH) (faxTop - 462) TEXT_BOX_WIDTH TEXT_BOX_HEIGHT], ...
        'BackgroundColor', 'white', ...
        'FontSize', SYS_FONT_SIZE, ...
        'FontName', 'FixedWidth', ...
        'HorizontalAlignment', 'left');
    ...
    function [success] = get_data()
        ...
        mat = matrix_MED(chan_list, start_time, end_time, n_out_samps, passwordTextbox.UserData.password, antialias, detrend, trace_ranges, persist_num);
    ...
    function show_command(chan_list)   
        ...
        command = [variableNameTextbox.String ' = matrix_MED(file_list, ' start_time ', ' end_time ', ' n_out_samps ', ''<password>'', ' antialias ', ' detrend ', ' trace_ranges ', ''' persist_str ''');' newline];
        disp(command);
